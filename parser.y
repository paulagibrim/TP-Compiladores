...
%token <str> ANOTA
%token <str> AI_CE_JUNTA AI_CE_DIMINUI CE_MULTIPLICA_POR CE_DIVIDE_POR
%token <str> ENGUAL NADA_A_VER_COM MAIOR_QUE MENOR_QUE
%token <str> LPAREN RPAREN LBRACE RBRACE COLLON COMMA DOT
%token <str> UNDERSCORE OR_OP AND_OP NOT_OP 
